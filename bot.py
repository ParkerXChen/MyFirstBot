...
import os
import rewards
import guesscmd,coins,votecmd, pinfocmd, ainfocmd
...
commands = rewards.get_command() + guesscmd.get_command() +  coins.get_command() + votecmd.get_command() + pinfocmd.get_command() + ainfocmd.get_command()
bot = updater.bot
